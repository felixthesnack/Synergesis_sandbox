...
public class CardDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cardList.Add(new Card(10, "Gold", "Summoning", 2, 1, 0, 2, "Draw 1 card and earn 2 gold", false, 0));
        cardList.Add(new Card(14, "Black", "Summoning", 2, 2, 0, 0, "Draw 2 card", false, 0));
        cardList.Add(new Card(8, "White", "Magical", 3, 0, 3, 0, "Earn 3 mana", false, 0));
        cardList.Add(new Card(9, "Gold", "Magical", 1, 0, 1, 2, "Earn 2 gold and 1 mana", false, 0));
        cardList.Add(new Card(13, "Black", "Magical", 2, 1, 2, 0, "Draw 1 card and earn 2 mana", false, 0));
        cardList.Add(new Card(7, "White", "Wealthy", 2, 0, 2, 1, "Earn 2 mana and 1 gold", false, 0));
        cardList.Add(new Card(11, "Gold", "Wealthy", 3, 0, 0, 3, "Earn 3 gold", false, 0));
        cardList.Add(new Card(12, "Black", "Wealthy", 1, 1, 0, 2, "Draw 1 card and earn 2 gold", false, 0));
        ...
        cardList.Add(new Card(29, "Colorless", "Medicinal", 1, 0, 0, 0, "Heal 1 heart and trash this card<br>Plays on draw<br>Still gives one meter charge<br>Counts as all colors", false, 0));
        cardList.Add(new Card(30, "Gold", "Frugal", 3, 0, 0, 1, "Earn 1 gold for every card played after this one", false, 0));

        //skills
        cardList.Add(new Card(31, "Black", "Motivating", 1, 1, 1, 0, "Lower one card priority by 1 for your next turn", true, 2));
        cardList.Add(new Card(32, "Black", "Encouraging", 1, 1, 0, 1, "Raise one card priority by 1 for your next turn", true, 2));
        cardList.Add(new Card(33, "White", "Mystical", 3, 0, 1, 1, "Spend 40 mana to add 2 card to your starting hand next turn", true, 3));
        cardList.Add(new Card(34, "Gold", "Extravagant", 3, 0, 0, 1, "Spend up to 120 gold to add extra card to your starting hand in the next turn at 30 gold per card", true, 3));
        ...
        cardList.Add(new Card(36, "White", "Speculative", 1, 0, 1, 1, "Add 1 extra card to your starting hand on the next turn", true, 3));
        cardList.Add(new Card(37, "Black", "Tidy", 3, 1, 0, 0, "Trash this card and another card from your deck and add 1 black starter card with priority 1", true, 0));
        cardList.Add(new Card(38, "Gold", "Thrifty", 2, 0, 0, 1, "Recieve 5 coins, but you must trash a card this draft phase", true, 5));
        cardList.Add(new Card(39, "Colorless", "Neutral", 1, 0, 0, 0, "Skip the draft by not taking or trashing any card from your deck", true, 4));
    }
}
